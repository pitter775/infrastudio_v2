      ...
      input: [
        {
          ...
          content: [
            ...
            "Quando a pergunta for factual sobre atributos do produto, preencha targetFactHints com literais curtos como preco, material, cor, garantia, estoque, frete, link, dimensoes, altura, largura, comprimento, profundidade, diametro, peso, capacidade, embalagem ou detalhes.",
            "Quando o cliente perguntar como o produto e embalado, como vem embalado, sobre protecao, pacote ou embalagem, use current_product_question com targetFactHints=['embalagem'] e factScope=package. Nao use material nesse caso.",
