(function () {
  ...
  function createExpandIcon(expanded) {
    if (expanded) {
      return '<span class="chat-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M9 9H5V5m10 0h4v4M9 15H5v4m14-4v4h-4" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 8l-3-3m11 0l3-3M8 16l-3 3m11-3l3 3" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/></svg></span>';
    }

    return '<span class="chat-icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none"><path d="M14 4h6v6M10 4H4v6m16 4v6h-6M10 20H4v-6" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/><path d="M13 11l7-7M11 11L4 4m9 2h7m-7-2v7M11 13l-7 7m0-7v7h7" stroke="currentColor" stroke-width="1.9" stroke-linecap="round" stroke-linejoin="round"/></svg></span>';
  }
  ...
  function applyUi(instance) {
    ...
    refs.subtitle.textContent = ui.subtitle || "";
